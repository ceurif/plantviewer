...
import com.plant.gestures.MoveGestureDetector;
import com.plant.gestures.RotateGestureDetector;
...
public class CropActivity extends Activity implements OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(extras != null) {
              ...
              Bitmap photoImg = BitmapFactory.decodeFile(Environment.getExternalStorageDirectory() + "/DCIM/OpenCamera/"+ img);
